...
public class PatientRecordControllerTest {
    ...
    /* L'interface PatientRecordRepository est utilisée dans tous les points de terminaison de l'API, nous nous en sommes donc moqués avec @MockBean.
     *  Enfin, nous avons créé quelques instances PatientRecord à des fins de test. */
